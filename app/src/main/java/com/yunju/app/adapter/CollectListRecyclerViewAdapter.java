...
public class CollectListRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<HouseSearchResponse.DataBean> list;
    private Context context;

    public CollectListRecyclerViewAdapter(Context context, List<HouseSearchResponse.DataBean> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_recyclerview_collectlist, parent, false);
