...
import com.yunju.app.activity.PayOrderActivity;
...
public class WaitPayOrderFragment extends BaseFragment {
    ...
    protected void initEvent() {
        ...
        mOrderAdapter.setOnRePayListener(new MyOrderAdapter.OnRePayListener() {
            @Override
            public void onReyPay(int position) {
                Bundle bundle = new Bundle();
                bundle.putString("osn",mOrderList.get(position).getId()+"");
